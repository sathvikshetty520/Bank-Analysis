...
CATEGORY_RULES = [
    ...
    ("BANK_CHARGES_FEES", r"SMS (ALERT )?CHARGES|SERVICE CHARGE|ANNUAL CHARGES|SLABWISE|DEBIT CARD ANNUAL|STOP CHEQUE|DEBIT CARD ISSUANCE FEES|OUTWARD PAYMENT CHARGES"),
...
NON_DUPLICATE_CATEGORIES = {"GST_TAX", "BANK_CHARGES_FEES", "ATM_INSUFFICIENT_FUNDS_FEE", "ATM_TRANSACTION_FEE"}
